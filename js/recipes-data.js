const recipes = [
  ...
  },
  {
    ...
    instructions: {
      sr: ["U šerpi zagrej maslinovo ulje i kratko prodinstaj sitno seckan beli luk.", "Dodaj iseckane šargarepe, krompir i celer, pa dinstaj par minuta da povrće pusti miris.", "Ubaci narendani đumbir i kurkumu, promešaj.", "Dolij bujon od povrća, posoli i pobiberi, pa kuvaj dok povrće ne omekša (20–25 minuta).", "Izblendiraj sve u glatku krem supu.", "Po želji ukrasi kapljicom maslinovog ulja, svežim peršunom ili semenkama bundeve."],
